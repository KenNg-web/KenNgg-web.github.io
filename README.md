...
<style>
  ...
  .container{width:1000px;background:#fff;padding:22px;border-radius:12px;box-shadow:0 8px 20px rgba(0,0,0,.12);}
...
function renderInputs(id){
  ...
  if(type === 'Mortgage'){
    ...
    html += `<label>Cash Back Mode</label>
             ...
             <input id="cashback${id}" type="text" placeholder="Make Sure Cash Back Mode Is Selected" style="margin-top:6px">`;
